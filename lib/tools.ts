...
export const tools: Tool[] = [
  {
    ...
    description:
      "Create and manage professional templates with customizable variables",
    icon: "FileText",
  ...
  },
  {
    ...
    description:
      "Store, organize, and manage your code snippets with powerful search and categorization",
    icon: "Code",
